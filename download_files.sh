...
aws s3 cp s3://ai-ml-ebu-datasets/datasets/kyc-compliance/entity-relevance/mixed-type-attempt/mixmodel_samples_company_test.json ./data/
aws s3 cp s3://ai-ml-ebu-datasets/datasets/kyc-compliance/entity-relevance/mixed-type-attempt/mixmodel_samples_company_train.json ./data/
aws s3 cp s3://ai-ml-ebu-datasets/datasets/kyc-compliance/entity-relevance/mixed-type-attempt/mixmodel_samples_person_test.json ./data/
aws s3 cp s3://ai-ml-ebu-datasets/datasets/kyc-compliance/entity-relevance/mixed-type-attempt/mixmodel_samples_person_train.json ./data/
